...
image: "https://cdn.cubeyond.net/gh/CuB3y0nd/picx-images-hosting@master/.67xtux8127.avif"
tags: ["Pwn", "CHOP", "Notes"]
category: "Notes"
draft: false
---
...
<center>
  <img src="https://cdn.cubeyond.net/gh/CuB3y0nd/picx-images-hosting@master/.2ksaalfwn4.avif" alt="" />
</center>

执行完 `_Unwind_Resume` 后 `rbp` 就变成了我们写入的 `B`，然后继续往下执行，最终卡在了这个地方：

<center>
  <img src="https://cdn.cubeyond.net/gh/CuB3y0nd/picx-images-hosting@master/.pfphz109v.avif" alt="" />
</center>
...
<center>
  <img src="https://cdn.cubeyond.net/gh/CuB3y0nd/picx-images-hosting@master/.6f11tkdlft.avif" alt="" />
</center>

现在我们尝试覆盖返回地址，看看会发生什么：

<center>
  <img src="https://cdn.cubeyond.net/gh/CuB3y0nd/picx-images-hosting@master/.szbfpmqwq.avif" alt="" />
</center>

又是因为访问非法地址而 abort，这次是 `rax`，而 `rax` 存的是我们覆盖的返回地址。嗯……如果继续用 bss 地址代替会发生什么呢？

<center>
  <img src="https://cdn.cubeyond.net/gh/CuB3y0nd/picx-images-hosting@master/.45i1a3etar.avif" alt="" />
  <img src="https://cdn.cubeyond.net/gh/CuB3y0nd/picx-images-hosting@master/.6m49p0rvc0.avif" alt="" />
</center>
