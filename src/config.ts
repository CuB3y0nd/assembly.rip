...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "https://v6.gh-proxy.org/https://github.com/CuB3y0nd/picx-images-hosting/raw/master/.1lc58276dr.avif",
		position: "center",
		credit: {
			enable: true,
			text: "落日歸山海，與你話清風。",
...
export const profileConfig: ProfileConfig = {
	avatar:
		"https://v6.gh-proxy.org/https://github.com/CuB3y0nd/picx-images-hosting/raw/master/.6bhhs4m1zp.avif",
	name: "CuB3y0nd",
	bio: "心之所向，一苇以航。",
	links: [
		{
